...
> 本文件由 LLM 维护。每次摄入操作后自动更新。查询时先读这里定位相关页面。
...
- [[process-vs-outcome-supervision]] — 结果监督 vs 过程监督：RL 的根本缺陷、过程监督的对抗样本难题
- [[scalable-oversight]] — 规模化监督：让 AI 协助监督 AI 的方法论

## 实体 (entities)

- [[andrej-karpathy]] — Andrej Karpathy：前 OpenAI/Tesla AI，认知核心、RL 批评等核心观点
- [[anthropic]] — Anthropic：AI 安全公司，Claude 的开发者
